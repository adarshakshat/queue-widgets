...
define( 'QU__FILE__', __FILE__ );
define( 'QU_URL', plugins_url( '/', QU__FILE__ ) );
define( 'QU_ASSETS_URL', QU_URL . 'assets/' );
...
final class Elementor_Hello_World {
	...
	public function init() {
		...
		require_once( 'inc/podcast-post-type.php' );
		require_once( 'load-cmb2.php' );
	}
